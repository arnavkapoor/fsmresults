...
filewrite= open(os.path.join('/home/arnav/fsm/tests/prefix-list-opensrc',namefile),"w")
...
for i in range(0,len(userinput)):
    filewrite1.write(str(userinput[i])+" "+str(currstate[i])+" "+str(nextstate[i])+" "+str(useroutput[i])+ "\n")
